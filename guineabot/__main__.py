...
def simulate_guinea_pig(duration: int, photos: str, level: str, quiet: bool) -> None:
    """
    Guinea Pig Twitter bot.
    :param duration: The number of days the bot should run for
    ...
    gp_machine = build_guinea_pig_machine(duration)
    if quiet:
