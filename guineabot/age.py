...
class Age:
    ...
    def __init__(self, span: int, interval: int, accelerated: bool) -> None:
        """
        Initialise an age tracking instance.
        :param span: How long to track the age in days
        ...
        # Calculate the number of interval ticks over the span.
        self.__max_age = (self.__span * 24 * 60) // self.__interval
        self.__age_clock = 0
    ...
    def stats(self, duration: int) -> [float, str]:
        ...
        average = self.__format_age_time(duration * self.__interval // self.__span)
